...
| "Корпоративный" (предварительная версия) | Высокопроизводительные кэши на основе программного обеспечения Redis Enterprise Redis Labs. Этот уровень поддерживает модули Redis, включая RediSearch, RedisBloom и RedisTimeSeries. Он также обеспечивает еще больший уровень доступности, чем уровень "Премиум". |
| Enterprise Flash (предварительная версия) | Большие рентабельные кэши на основе программного обеспечения Redis Enterprise Redis Labs. Этот уровень расширяет хранилище данных Redis на виртуальной машине до энергонезависимой памяти, которая является менее затратной, чем DRAM. Это снижает общую стоимость памяти за один ГБ. |
...
| [Избыточность в пределах зоны](cache-how-to-zone-redundancy.md) |-|-|Preview (Предварительный просмотр)|Preview (Предварительный просмотр)|Preview (Предварительный просмотр)|
...
### <a name="enterprise-and-enterprise-flash-tier-requirements"></a>Требования к уровням "Корпоративный" и Enterprise Flash
