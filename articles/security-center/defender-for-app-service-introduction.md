...
| Цены:                     | Плата за использование [Azure Defender для Службы приложений](azure-defender.md) начисляется по тарифам, приведенным на [странице с ценами](security-center-pricing.md).<br>Выставление счетов осуществляется в соответствии с общим количеством вычислительных экземпляров во всех планах.|
| Поддерживаемые планы Службы приложений: | Поддерживаются все планы службы приложений (за одним исключением, см. сведения ниже). [Ознакомьтесь с дополнительными сведениями о планах Службы приложений](https://azure.microsoft.com/pricing/details/app-service/plans/).<br>План потребления не поддерживает Функции Azure. [Ознакомьтесь с дополнительными сведениями о вариантах размещения в Функциях Azure](../azure-functions/functions-scale.md).                                                                                                                                                                                                                                                                   |
