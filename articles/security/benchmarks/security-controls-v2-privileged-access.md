...
Чтобы просмотреть подходящую встроенную политику Azure, ознакомьтесь со статьей [сведения о встроенной инициативе по обеспечению безопасности в Azure: привилегированный доступ](../../governance/policy/samples/azure-security-benchmark#privileged-access)
...
- [Развертывание рабочей станции с привилегированным доступом](../../active-directory/devices/howto-azure-managed-workstation)
