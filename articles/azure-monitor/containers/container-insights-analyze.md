...
Основные отличия в наблюдении за кластером Windows Server с контейнерной аналитикой по сравнению с кластером Linux описаны [здесь](container-insights-overview.md#what-does-azure-monitor-for-containers-provide) в обзорной статье.
