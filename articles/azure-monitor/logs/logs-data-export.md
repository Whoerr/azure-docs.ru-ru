...
> [!IMPORTANT]
> [Количество поддерживаемых концентраторов событий на пространство имен равно 10](../../event-hubs/event-hubs-quotas#common-limits-for-all-tiers). При экспорте более 10 таблиц укажите собственное имя концентратора событий, чтобы экспортировать все таблицы в этот концентратор событий. 
