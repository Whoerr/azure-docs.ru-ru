...
1. Нажмите **Добавить**. Откроется страница обзора для нового приложения.
...
1. Нажмите **Добавить**. Ключ PingAccess появляется в таблице секретов клиента со случайной строкой, заполняемой в поле **значение** .
