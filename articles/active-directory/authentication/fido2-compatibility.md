...
Следующие сочетания операционных систем и браузеров не поддерживаются, однако исследование и тестирование осуществляется в будущем. Если вы хотите увидеть дополнительную поддержку операционной системы и браузера, оставьте отзыв, используя средство обратной связи с продуктом в нижней части страницы.
