...
| Память                   | 443, Сервицетаг: хранилище                              | TCP          | Любой        | Любой                       | Allow      | Плоскость управления, использующая хранилище BLOB-объектов Azure. <br/>(Если включен пиринг Майкрософт, это правило может не понадобиться.)                                                             |
