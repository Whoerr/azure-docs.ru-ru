...
[Создание рабочей области в Azure синапсе Analytics с поддержкой утечка данных.](../synapse-analytics/security/how-to-create-a-workspace-with-data-exfiltration-protection.md) С помощью [защиты данных утечка](../synapse-analytics/security/workspace-data-exfiltration-protection.md)можно гарантировать, что злоумышленники не смогут копировать или передавать данные из ресурсов Azure в расположения за пределами области организации.
