...
Нет. При создании контейнера с включенным аналитическим хранилищем и запуске загрузки данных будет использоваться только накладная.
