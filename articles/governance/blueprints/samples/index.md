...
| [Базовая среда для Azure Security Benchmark](./azure-security-benchmark-foundation/index.md) | Развертывание и настройка базовой среды для Azure Security Benchmark. |
