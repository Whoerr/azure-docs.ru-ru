...
+ Куерилангуаже определяет, какие словари используются для проверки орфографии, а также используется в качестве входных данных для [алгоритма семантического ранжирования](semantic-how-to-query-response.md) , если используется "queryType = семантика".
